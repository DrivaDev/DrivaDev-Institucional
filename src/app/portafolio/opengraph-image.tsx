  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ color: "#FED7AA" }}>Proyectos de&nbsp;</span>
          <span style={{ color: "#EA580C" }}>desarrollo web.</span>
        </div>
        <div style={{ color: "rgba(255,255,255,0.5)", fontSize: "26px", fontFamily: "sans-serif", letterSpacing: "0.01em" }}>
          Portafolio · Productos SaaS propios y sistemas para clientes · drivadev.com.ar
        </div>
      </div>
    ),
    { ...size }
