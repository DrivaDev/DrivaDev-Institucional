...
export const alt = "Desarrollo web a medida en Buenos Aires | Driva Dev";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ color: "#FED7AA" }}>Desarrollo web a medida en&nbsp;</span>
          <span style={{ color: "#EA580C" }}>Buenos Aires.</span>
        </div>
        <div style={{ color: "rgba(255,255,255,0.5)", fontSize: "26px", fontFamily: "sans-serif" }}>
          CABA y Gran Buenos Aires · Código propio, sin plantillas · drivadev.com.ar
        </div>
      </div>
    ),
    { ...size }
